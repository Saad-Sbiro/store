    ...
    <div className="min-h-screen bg-surface-0">
      ...
      <section className="relative overflow-hidden bg-ink-900 pb-20 pt-[132px] text-white sm:pb-28 sm:pt-[148px]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            زادي was born from a simple belief: the right products should make everyday life easier. We select practical technology and useful essentials with delivery across Morocco.
          </motion.p>
        </div>
      </section>
